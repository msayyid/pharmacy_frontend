...
// Card variants per DESIGN §11.2:
//   default — 1px ring, no shadow (most surfaces sit on the canvas)
//   raised  — 1px ring + --shadow-elev1 (sticky headers, modals over content)
// The size dimension stays as shadcn shipped it (default | sm) and is unrelated
// to elevation.
function Card({
  className,
  size = "default",
